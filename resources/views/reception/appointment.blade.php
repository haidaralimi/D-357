                                ...
                                <div class="input-group col-md-12 col-xs-12">
                                        <span class="input-group-btn">
                                                <button type="submit" class="btn btn-primary"><i
                                                            class="fa fa-search"></i>&nbsp;{{trans('file.search')}}</button>
                                        </span>
                                                <input type="text"
                                                       placeholder="{{trans('file.search_patient_name_id')}}"
                                    ...
                                    @if(count($patient_all)>0)
                                        @foreach($patient_all as $patients)
                                            <tr>
                                                ...
                                                <td>{{ str_limit($patients->next_appointment,16 )}}
                                                    , {{ $patients->time }} {{ $patients->meridiem }}</td>
                                                <td>{{ $patients->deposit }}</td>
                                                <td><a class="btn btn-xs btn-primary" data-toggle="modal"
                                                       data-target="#e{{$patients->id}}">Set appointment &nbsp;<i
                                                                class="fa fa-history"></i></a></td>
                                                <td><a class="btn btn-xs btn-success"
                                                       href="/patient_report/{{ $patients->id }}">History &nbsp; <i
                                                                class="fa fa-file-pdf-o"></i></a></td>
                                                <td><a class="btn btn-xs btn-success"
                                                       href="/patient_fee/{{ $patients->id }}">Fee &nbsp;&nbsp;<i
                                                                class="fa fa-file-pdf-o"></i></a></td>


                                                <td><a class="btn btn-xs btn-info"
                                                       href="/patient/{{ $patients->id }}/edit">Edit &nbsp;<i
                                                                class="fa fa-edit"></i></a></td>
                                                <td>
                                                    <form action="/patient/{{ $patients->id }}" method="post">
                                                        @method('delete')
                                                        <button class="btn btn-xs btn-danger demo4" type="submit">Delete
                ...
                <div class="modal-content animated fadeIn">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i
                                    class="fa fa-history"></i>&nbsp;&nbsp;{{trans('file.change_appointment')}}</h4>
                    </div>
